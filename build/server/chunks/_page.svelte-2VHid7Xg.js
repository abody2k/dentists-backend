...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let mode = 0;
  $$result.css.add(css);
  return `${validate_component(Bar, "Bar").$$render($$result, { title: "Store", auth: 2 }, {}, {})} <div class="row svelte-11ck34q" style="gap:20px;margin:5px;">${validate_component(Button, "Button").$$render(
    $$result,
    {
      text: "العروض",
      clickHandler: () => {
...
//# sourceMappingURL=_page.svelte-2VHid7Xg.js.map
