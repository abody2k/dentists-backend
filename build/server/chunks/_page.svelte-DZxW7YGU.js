...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${``} ${validate_component(Bar, "Bar").$$render($$result, { title: "Courses" }, {}, {})} <div class=""><div style="display: flex;gap:30px;justify-content:right; margin: 20px;height:120px;">${`<div style="display:flex;gap:10px;"><div class="Xtabs svelte-uiyu3g" style="height: 120px; display:flex;flex-direction:row;gap:10px;font-size:17px;" data-svelte-h="svelte-mzlbmu"><img src="/add.png" width="20" height="20"> <span>إنشاء كورس</span></div></div>`} <div id="arch" class="svelte-uiyu3g"><div style="display: flex;gap: 30px;justify-content: right;margin: 30px;"><div>${escape("عرض الكورسات المؤرشفة")}</div></div></div></div> ${validate_component(Grid, "Grid").$$render(
    $$result,
    {
      f: false,
      showArchivedOnly,
...
//# sourceMappingURL=_page.svelte-DZxW7YGU.js.map
