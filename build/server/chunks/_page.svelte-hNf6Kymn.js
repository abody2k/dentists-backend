...
const css$2 = {
  code: "a.svelte-tuz4at{color:navy;padding:7px;font-weight:bold}",
  map: null
};
const Path = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${each(links, (link, i) => {
    return `<a${add_attribute("href", link.link, 0)} class="svelte-tuz4at">${escape(link.txt)}</a> ${i + 1 != links.length ? `&gt;&gt;` : ``}`;
  })}`;
});
const css$1 = {
...
//# sourceMappingURL=_page.svelte-hNf6Kymn.js.map
