import { c as create_ssr_component, e as escape, d as add_attribute, f as each } from './ssr-JWmjUSZd.js';
...
const AdminExam = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { save } = $$props;
  let { groups } = $$props;
  if ($$props.switchToQuestions === void 0 && $$bindings.switchToQuestions && switchToQuestions !== void 0) $$bindings.switchToQuestions(switchToQuestions);
...
const AdminQuestions = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.switchToMainExams === void 0 && $$bindings.switchToMainExams && switchToMainExams !== void 0) $$bindings.switchToMainExams(switchToMainExams);
  if ($$props.data === void 0 && $$bindings.data && data !== void 0) $$bindings.data(data);
  if ($$props.saveQuestions === void 0 && $$bindings.saveQuestions && saveQuestions !== void 0) $$bindings.saveQuestions(saveQuestions);
  $$result.css.add(css);
...
//# sourceMappingURL=AdminQuestions-B3FMbYE8.js.map
