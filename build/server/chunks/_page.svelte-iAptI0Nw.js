...
import { C as CourseData } from './CourseData-BTi9U6CE.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${``} ${validate_component(TopBar, "TopBar").$$render($$result, {}, {}, {})} <div class="scroll-box svelte-1gjvtnn">${validate_component(CourseData, "CourseData").$$render(
    $$result,
    {
      ...
      src: "https://echo-dentists.s3.amazonaws.com/fellowships/" + meta.fellowshipID + "/0",
      func() {
...
//# sourceMappingURL=_page.svelte-iAptI0Nw.js.map
