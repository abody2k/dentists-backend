...
import { T as TopBar } from './TopBar-CbxRxeV3.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `${validate_component(TopBar, "TopBar").$$render($$result, {}, {}, {})} <div style="display: flex;justify-content:center;flex-direction:column;gap:40px;align-items:center;"> ${makeNew ? `${validate_component(BlogCard, "BlogCard").$$render(
    $$result,
    {
      makeNew: true,
...
//# sourceMappingURL=_page.svelte-DSKAtPaa.js.map
