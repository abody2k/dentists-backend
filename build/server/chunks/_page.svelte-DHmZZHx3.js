import { c as create_ssr_component, d as add_attribute, e as escape, f as each, v as validate_component } from './ssr-CIpp2D7Y.js';
import { M as Map } from './Map-DRdZag4Q.js';

/* empty css                                                  */
const css$1 = {
  code: ".svelte-sumc1k{font-family:'Tajawal'}.neumorphic-card.svelte-sumc1k{border-radius:22px;background:#E6E7EE;box-shadow:inset 7px 7px 14px  rgba(0, 0, 0, 0.1) ,\r\n            inset -7px -7px 14px rgba(255, 255, 255, 0.7)}.black-title.svelte-sumc1k{color:black;font-weight:bold}.rectangular-image.svelte-sumc1k{width:80%;background-size:cover;height:40%;border-radius:22px}",
  map: null
};
const Blog = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { text = "Default Second Title" } = $$props;
  let { src = "" } = $$props;
  ...
  return `   <div class="svelte-sumc1k">  <div class="neumorphic-card svelte-sumc1k" style="padding: 20px;"><div style="text-align: center;" class="svelte-sumc1k">  <img${add_attribute("src", src, 0)} alt="Neumorphic Picture" id="blog-image" class="rectangular-image svelte-sumc1k">   <div class="black-title svelte-sumc1k">${escape(text)}</div>  </div></div></div>`;
});
const css = {
...
//# sourceMappingURL=_page.svelte-DHmZZHx3.js.map
