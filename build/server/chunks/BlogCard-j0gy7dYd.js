...
const BlogCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${state == 0 ? `<div class="card svelte-18wrlo8" style="width: 70%;"><div><div><div style="width: 100%; height: 200px; display: flex; align-items: center; justify-content: center; background-color: #efefff;"><label for="files"><img${add_attribute("src", url ? url : "/addImage.png", 0)}${add_attribute("style", url ? "width:100%;height:120px;" : "width: 40px;", 0)}></label></div> <input type="file" placeholder="/addImage.png" style="display: none;" id="files"> <div class="column svelte-18wrlo8" style="align-items: center;"><input placeholder="العنوان" style="width: 80%;"${add_attribute("value", title, 0)}> <input placeholder="الوصف" style="width: 90%;" multiple${add_attribute("value", details, 0)}></div></div></div></div>` : `${state == 1 ? `<div class="card svelte-18wrlo8" style="width: 70%;"><div class="column svelte-18wrlo8"><img${add_attribute("src", url, 0)} style="width: 100%;height:30vh"> <input placeholder="العنوان"${add_attribute("value", title, 0)}> <input placeholder="الوصف"${add_attribute("value", details, 0)}></div></div>` : `<div class="postCard svelte-18wrlo8"><div class="imageCont svelte-18wrlo8"><img${add_attribute("src", url + "/0", 0)} alt="image1" class="svelte-18wrlo8"></div> <div class="captionCont svelte-18wrlo8"><h2 style="margin:-2px 0 -10px 0; ">${escape(title)}</h2> <p class="svelte-18wrlo8">${escape(details)}</p></div></div>`}`}`;
});

export { BlogCard as B };
//# sourceMappingURL=BlogCard-j0gy7dYd.js.map
