...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${``} ${validate_component(Bar, "Bar").$$render($$result, { title: "Fellowships" }, {}, {})} <div class=""><div style="display: flex;gap:30px; margin: 20px;">${`${validate_component(ButtonChild, "ButtonChild").$$render(
    $$result,
    {
      child: `
...
//# sourceMappingURL=_page.svelte-DWzCHCgR.js.map
