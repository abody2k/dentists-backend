import { c as create_ssr_component, f as each, v as validate_component, d as add_attribute, e as escape } from './ssr-C5Pny6Bf.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<div style="display: flex;justify-content:center;flex-direction:column;gap:40px;align-items:center;"><button data-svelte-h="svelte-t9bqwi">منشور جديد</button> ${makeNew ? `${validate_component(BlogCard, "BlogCard").$$render(
    $$result,
    {
      makeNew: true,
...
//# sourceMappingURL=_page.svelte-BBx2fTXr.js.map
