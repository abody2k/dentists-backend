...
return {
	...
	_: {
		client: {"start":"_app/immutable/entry/start.DsC8psKQ.js","app":"_app/immutable/entry/app.BCV-TLdl.js","imports":["_app/immutable/entry/start.DsC8psKQ.js","_app/immutable/chunks/entry.BKImVG1A.js","_app/immutable/chunks/scheduler.C7Xo_3aa.js","_app/immutable/chunks/index.DTVtpEo5.js","_app/immutable/entry/app.BCV-TLdl.js","_app/immutable/chunks/preload-helper.D6kgxu3v.js","_app/immutable/chunks/scheduler.C7Xo_3aa.js","_app/immutable/chunks/index.NYh16Rov.js"],"stylesheets":[],"fonts":[],"uses_env_dynamic_public":false},
		nodes: [
			__memo(() => import('./chunks/0-CZXWwoBJ.js')),
			__memo(() => import('./chunks/1-Oj9_cYxM.js')),
			__memo(() => import('./chunks/2-BQXS7Jcv.js')),
			__memo(() => import('./chunks/3-CPGRe6an.js')),
			__memo(() => import('./chunks/4-D5TssE2P.js')),
			__memo(() => import('./chunks/5-BJM129qz.js')),
			__memo(() => import('./chunks/6-BdJ6WfpY.js')),
			__memo(() => import('./chunks/7-CZILOBUt.js')),
			__memo(() => import('./chunks/8-DeOVpKsO.js')),
			__memo(() => import('./chunks/9-DFWXftR-.js')),
			__memo(() => import('./chunks/10-C1PEZmB_.js')),
			__memo(() => import('./chunks/11-ioQbCPlo.js')),
			__memo(() => import('./chunks/12-ChcKJ9zD.js')),
			__memo(() => import('./chunks/13-Buz3h7UF.js')),
			__memo(() => import('./chunks/14-CM26u_rG.js')),
			__memo(() => import('./chunks/15-Dbiu_KEt.js')),
			__memo(() => import('./chunks/16-eCMi7ovH.js')),
			__memo(() => import('./chunks/17-CpuSFQV4.js')),
			__memo(() => import('./chunks/18-DJDJjsnh.js')),
			__memo(() => import('./chunks/19-CHBhJKCS.js')),
			__memo(() => import('./chunks/20-CbuH52Wk.js')),
			__memo(() => import('./chunks/21-B1Ph1iso.js')),
			__memo(() => import('./chunks/22-DHTwHNjA.js')),
			__memo(() => import('./chunks/23-DFi8HP7x.js')),
			__memo(() => import('./chunks/24-CD69aJAf.js')),
			__memo(() => import('./chunks/25-C0ZV_Z3I.js')),
			__memo(() => import('./chunks/26-pGsAzVQP.js')),
			__memo(() => import('./chunks/27-Da1XQAfj.js')),
			__memo(() => import('./chunks/28-BKGjNxct.js')),
			__memo(() => import('./chunks/29-Bpxmi_U4.js')),
			__memo(() => import('./chunks/30-Bh9yukw-.js')),
			__memo(() => import('./chunks/31-C1E8py6E.js')),
			__memo(() => import('./chunks/32-COcBJaXZ.js')),
			__memo(() => import('./chunks/33-Bo2QHNk-.js')),
			__memo(() => import('./chunks/34-hJ-XkBe2.js')),
			__memo(() => import('./chunks/35-Ck4gD9-e.js')),
			__memo(() => import('./chunks/36-CaA7vSWq.js')),
			__memo(() => import('./chunks/37-DTEalw4P.js')),
			__memo(() => import('./chunks/38-CeBYvhii.js')),
			__memo(() => import('./chunks/39-Bv9t2rIi.js')),
			__memo(() => import('./chunks/40-DNlzs8t5.js')),
			__memo(() => import('./chunks/41-B4XDlKrF.js')),
			__memo(() => import('./chunks/42-B9NQYCfb.js')),
			__memo(() => import('./chunks/43-C4KRFHj8.js')),
			__memo(() => import('./chunks/44-DDkPgH2I.js')),
			__memo(() => import('./chunks/45-BWhCY1yf.js')),
			__memo(() => import('./chunks/46-WBr6c3Ff.js'))
		],
		routes: [
			{
				id: "/",
			...
			{
				id: "/courses/[course]/[examType]/[examID]/[level]",
				pattern: /^\/courses\/([^/]+?)\/([^/]+?)\/([^/]+?)\/([^/]+?)\/?$/,
				params: [{"name":"course","optional":false,"rest":false,"chained":false},{"name":"examType","optional":false,"rest":false,"chained":false},{"name":"examID","optional":false,"rest":false,"chained":false},{"name":"level","optional":false,"rest":false,"chained":false}],
			...
			{
				id: "/fellowships/[fellowship]/[examType]/[examID]/[level]",
				pattern: /^\/fellowships\/([^/]+?)\/([^/]+?)\/([^/]+?)\/([^/]+?)\/?$/,
				params: [{"name":"fellowship","optional":false,"rest":false,"chained":false},{"name":"examType","optional":false,"rest":false,"chained":false},{"name":"examID","optional":false,"rest":false,"chained":false},{"name":"level","optional":false,"rest":false,"chained":false}],
