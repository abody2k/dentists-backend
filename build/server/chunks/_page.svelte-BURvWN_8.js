...
const Home = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div${add_attribute(
    ...
    color: #2e3b6f;`,
    0
  )}><div style="display: flex;flex-direction: column;justify-content: center;gap: 20px;width: 100%;min-height: 80vh;margin: 30px 0;"><div class="body1 svelte-1quevjl"><div class="LogoutSettingDiv svelte-1quevjl"><button class="svelte-1quevjl"><img src="/Settings.png" alt="" title="Settings" class="svelte-1quevjl"></button> <button class="svelte-1quevjl"><img src="/Logout.png" alt="" title="Logout" class="svelte-1quevjl"></button></div> <div class="topContent svelte-1quevjl"><div style="display: flex; justify-content: center;align-items: center;gap:10px; flex-wrap:wrap;"><img src="https://echo-dentists.s3.me-central-1.amazonaws.com/EDTULOGO.png" alt="" style="width: 100px;height: 100px;filter: drop-shadow(2px 4px 2px #00000020);"> <a style="display: flex;font-size: 14px;cursor: pointer;color:#2e3b6f;">Go to Website 
                <img src="/ExternalLink.png" alt="" style="width: 20px;height: 20px;margin-left: 5px;"></a></div> ${localStorage.getItem("t") == 0 ? `<div style="display: flex; justify-content: center;gap:10px; flex-wrap:wrap; margin: 20px 0;"><div class="rectTabs svelte-1quevjl" data-svelte-h="svelte-qzlo7l">Accounts</div> <div class="rectTabs svelte-1quevjl" data-svelte-h="svelte-aj4ua">Subscriptions</div> <div class="rectTabs svelte-1quevjl" data-svelte-h="svelte-z74og7">Exams results</div></div>` : ``}</div></div> <div class="body1 svelte-1quevjl" style="border-radius: 10px 10px 50px 50px;"><div style="display: flex;justify-content: center;gap: 15px;flex-wrap:wrap;margin: 30px 5px;">${``}</div></div></div></div>`;
});
...
//# sourceMappingURL=_page.svelte-BURvWN_8.js.map
