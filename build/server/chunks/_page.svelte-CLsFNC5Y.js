...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Course, "Course").$$render(
    ...
    {},
    {}
  )} ${`<div style="display: flex;justify-content:space-around" class="svelte-1d64gt6"><button class="svelte-1d64gt6">Make new ${escape("course")}</button> ${validate_component(ButtonChild, "ButtonChild").$$render(
    $$result,
    {
...
//# sourceMappingURL=_page.svelte-CLsFNC5Y.js.map
