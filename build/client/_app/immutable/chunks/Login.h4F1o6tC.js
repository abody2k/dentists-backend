import{s as Tn,e as p,a as I,t as Je,c as g,b as N,f as E,g as ae,d as A,m as Ye,v as le,p as u,h as B,i as Kt,j as f,w as be,q as oe,y as An,r as Dn}from"./scheduler.-OUPI9FG.js";import{S as Cn,i as kn,c as Bn,a as On,m as Nn,t as Mn,b as $n,e as Rn}from"./index.jRfWhGhs.js";import{B as Pn}from"./Button.DI0ciwgW.js";import{f as Et}from"./not.k57uuvnW.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Z=new Yn("@firebase/app"),lr="@firebase/app-compat",ur="@firebase/analytics-compat",dr="@firebase/analytics",fr="@firebase/app-check-compat",hr="@firebase/app-check",pr="@firebase/auth",gr="@firebase/auth-compat",br="@firebase/database",mr="@firebase/database-compat",wr="@firebase/functions",yr="@firebase/functions-compat",_r="@firebase/installations",vr="@firebase/installations-compat",Ir="@firebase/messaging",Er="@firebase/messaging-compat",Sr="@firebase/performance",Tr="@firebase/performance-compat",Ar="@firebase/remote-config",Dr="@firebase/remote-config-compat",Cr="@firebase/storage",kr="@firebase/storage-compat",Br="@firebase/firestore",Or="@firebase/firestore-compat",Nr="firebase",Mr={[Ze]:"fire-core",[lr]:"fire-core-compat",[dr]:"fire-analytics",[ur]:"fire-analytics-compat",[hr]:"fire-app-check",[fr]:"fire-app-check-compat",[pr]:"fire-auth",[gr]:"fire-auth-compat",[br]:"fire-rtdb",[mr]:"fire-rtdb-compat",[wr]:"fire-fn",[yr]:"fire-fn-compat",[_r]:"fire-iid",[vr]:"fire-iid-compat",[Ir]:"fire-fcm",[Er]:"fire-fcm-compat",[Sr]:"fire-perf",[Tr]:"fire-perf-compat",[Ar]:"fire-rc",[Dr]:"fire-rc-compat",[Cr]:"fire-gcs",[kr]:"fire-gcs-compat",[Br]:"fire-fst",[Or]:"fire-fst-compat","fire-js":"fire-js",[Nr]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ia(e,t,n){const r=Ea(t);(await e.firebaseDependencies.analyticsProvider.get()).logEvent(r,{message_id:n[_n],message_name:n[qs],message_time:n[Gs],message_device_time:Math.floor(Date.now()/1e3)})}function Ea(e){switch(e){case de.NOTIFICATION_CLICKED:return"notification_open";case de.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sa(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===de.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(jt(n)):e.onMessageHandler.next(jt(n)));const r=n.data;ga(r)&&r[Js]==="1"&&await Ia(e,n.messageType,r)}const Vt="@firebase/messaging",Ft="0.12.5";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ta=e=>{const t=new ma(e.getProvider("app").getImmediate(),e.getProvider("installations-internal").getImmediate(),e.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",n=>Sa(t,n)),t},Aa=e=>{const t=e.getProvider("messaging").getImmediate();return{getToken:r=>va(t,r)}};function Da(){ee(new Q("messaging",Ta,"PUBLIC")),ee(new Q("messaging-internal",Aa,"PRIVATE")),F(Vt,Ft),F(Vt,Ft,"esm2017")}Da();function zt(e){let t,n;return{c(){t=p("p"),n=Je(e[3]),this.h()},l(r){t=g(r,"P",{class:!0});var s=N(t);n=Ye(s,e[3]),s.forEach(A),this.h()},h(){u(t,"class","error-message svelte-yl5zze")},m(r,s){Kt(r,t,s),f(t,n)},p(r,s){s&8&&Dn(n,r[3])},d(r){r&&A(t)}}}function Ca(e){let t,n,r,s,a,o="Echo Dental Training Unit",c,i,l,d="LOG IN",D,_,M="Your email",K,x,m,W,bt,ve,C,Ie,U,mt="Your password",Ee,$,O,q,wt,Se,k,Te,S,fe,Ae,De,H,G,j,Ce,ke,R,yt="Lost password?",Be,J,Oe,Y,Ne,V,_t="Contacting us",ce,Me,vt,w=e[3]&&zt(e);return J=new Pn({props:{clickHandler:e[5],useTJ:!0,text:"Log in",width:"100%"}}),{c(){t=p("div"),n=p("img"),s=I(),a=p("h1"),a.textContent=o,c=I(),i=p("div"),l=p("h2"),l.textContent=d,D=I(),_=p("label"),_.textContent=M,K=I(),x=p("div"),m=p("div"),W=p("img"),ve=I(),C=p("input"),Ie=I(),U=p("label"),U.textContent=mt,Ee=I(),$=p("div"),O=p("div"),q=p("img"),Se=I(),k=p("input"),Te=I(),S=p("img"),Ae=I(),w&&w.c(),De=I(),H=p("div"),G=p("label"),j=p("input"),Ce=Je(`\r
          Remember me`),ke=I(),R=p("a"),R.textContent=yt,Be=I(),Bn(J.$$.fragment),Oe=I(),Y=p("p"),Ne=Je("Not registered? Create an account by "),V=p("u"),V.textContent=_t,this.h()},l(b){t=g(b,"DIV",{class:!0});var v=N(t);n=g(v,"IMG",{src:!0,alt:!0,width:!0,class:!0,style:!0}),s=E(v),a=g(v,"H1",{class:!0,style:!0,"data-svelte-h":!0}),ae(a)!=="svelte-wstfby"&&(a.textContent=o),c=E(v),i=g(v,"DIV",{class:!0,style:!0});var y=N(i);l=g(y,"H2",{class:!0,style:!0,"data-svelte-h":!0}),ae(l)!=="svelte-17ss5ox"&&(l.textContent=d),D=E(y),_=g(y,"LABEL",{class:!0,"data-svelte-h":!0}),ae(_)!=="svelte-9v1dp9"&&(_.textContent=M),K=E(y),x=g(y,"DIV",{class:!0});var It=N(x);m=g(It,"DIV",{class:!0});var he=N(m);W=g(he,"IMG",{src:!0,alt:!0,class:!0}),ve=E(he),C=g(he,"INPUT",{class:!0,type:!0,id:!0,placeholder:!0}),he.forEach(A),It.forEach(A),Ie=E(y),U=g(y,"LABEL",{class:!0,"data-svelte-h":!0}),ae(U)!=="svelte-15gn3f4"&&(U.textContent=mt),Ee=E(y),$=g(y,"DIV",{class:!0});var pe=N($);O=g(pe,"DIV",{class:!0});var se=N(O);q=g(se,"IMG",{src:!0,alt:!0,class:!0}),Se=E(se),k=g(se,"INPUT",{class:!0,type:!0,id:!0,placeholder:!0}),Te=E(se),S=g(se,"IMG",{src:!0,style:!0,class:!0}),se.forEach(A),Ae=E(pe),w&&w.l(pe),pe.forEach(A),De=E(y),H=g(y,"DIV",{class:!0});var ge=N(H);G=g(ge,"LABEL",{class:!0});var $e=N(G);j=g($e,"INPUT",{type:!0,class:!0}),Ce=Ye($e,`\r
          Remember me`),$e.forEach(A),ke=E(ge),R=g(ge,"A",{href:!0,class:!0,"data-svelte-h":!0}),ae(R)!=="svelte-1y00aro"&&(R.textContent=yt),ge.forEach(A),Be=E(y),On(J.$$.fragment,y),Oe=E(y),Y=g(y,"P",{class:!0});var Re=N(Y);Ne=Ye(Re,"Not registered? Create an account by "),V=g(Re,"U",{style:!0,"data-svelte-h":!0}),ae(V)!=="svelte-1wiuusi"&&(V.textContent=_t),Re.forEach(A),y.forEach(A),v.forEach(A),this.h()},h(){le(n.src,r="/Logo.png")||u(n,"src",r),u(n,"alt","Logo"),u(n,"width","90"),u(n,"class","logo svelte-yl5zze"),B(n,"bottom","10px"),B(n,"position","relative"),u(a,"class","main-title svelte-yl5zze"),B(a,"bottom","15px"),B(a,"position","relative"),u(l,"class","login-title svelte-yl5zze"),B(l,"margin","0 0 30px"),u(_,"class","svelte-yl5zze"),le(W.src,bt="/at.png")||u(W,"src",bt),u(W,"alt","name icon"),u(W,"class","svelte-yl5zze"),u(C,"class","inputField svelte-yl5zze"),u(C,"type","email"),u(C,"id","email"),u(C,"placeholder","Enter your email"),u(m,"class","inputFieldCon svelte-yl5zze"),u(x,"class","input-container svelte-yl5zze"),u(U,"class","svelte-yl5zze"),le(q.src,wt="/password.png")||u(q,"src",wt),u(q,"alt","name icon"),u(q,"class","svelte-yl5zze"),u(k,"class","inputField svelte-yl5zze"),u(k,"type","password"),u(k,"id","password"),u(k,"placeholder","Enter your password"),le(S.src,fe=e[4]?"/show.png":"/hide.png")||u(S,"src",fe),B(S,"width","20px"),B(S,"height","20px"),B(S,"position","absolute"),B(S,"left","79%"),u(S,"class","svelte-yl5zze"),u(O,"class","inputFieldCon svelte-yl5zze"),u($,"class","input-container svelte-yl5zze"),u(j,"type","checkbox"),u(j,"class","svelte-yl5zze"),u(G,"class","svelte-yl5zze"),u(R,"href","#"),u(R,"class","lost-password svelte-yl5zze"),u(H,"class","remember-lost-row svelte-yl5zze"),B(V,"cursor","pointer"),u(Y,"class","not-registered svelte-yl5zze"),u(i,"class","neumorphic-box svelte-yl5zze"),B(i,"margin","0 0 30px"),u(t,"class","login-container svelte-yl5zze")},m(b,v){Kt(b,t,v),f(t,n),f(t,s),f(t,a),f(t,c),f(t,i),f(i,l),f(i,D),f(i,_),f(i,K),f(i,x),f(x,m),f(m,W),f(m,ve),f(m,C),be(C,e[0]),f(i,Ie),f(i,U),f(i,Ee),f(i,$),f($,O),f(O,q),f(O,Se),f(O,k),be(k,e[1]),f(O,Te),f(O,S),f($,Ae),w&&w.m($,null),f(i,De),f(i,H),f(H,G),f(G,j),j.checked=e[2],f(G,Ce),f(H,ke),f(H,R),f(i,Be),Nn(J,i,null),f(i,Oe),f(i,Y),f(Y,Ne),f(Y,V),ce=!0,Me||(vt=[oe(C,"input",e[7]),oe(k,"input",e[8]),oe(S,"click",e[9]),oe(j,"change",e[10]),oe(R,"click",e[11]),oe(V,"click",e[12])],Me=!0)},p(b,[v]){v&1&&C.value!==b[0]&&be(C,b[0]),v&2&&k.value!==b[1]&&be(k,b[1]),(!ce||v&16&&!le(S.src,fe=b[4]?"/show.png":"/hide.png"))&&u(S,"src",fe),b[3]?w?w.p(b,v):(w=zt(b),w.c(),w.m($,null)):w&&(w.d(1),w=null),v&4&&(j.checked=b[2])},i(b){ce||(Mn(J.$$.fragment,b),ce=!0)},o(b){$n(J.$$.fragment,b),ce=!1},d(b){b&&A(t),w&&w.d(),Rn(J),Me=!1,An(vt)}}}function ka(e,t,n){let r="",s="",a=!1,o="",c=!1,{func:i}=t;function l(){r.length>7&&s.length>3?Et("n/si/",{email:r,p:s}).then(m=>{localStorage.setItem("li",!0),localStorage.setItem("t",m.t),localStorage.setItem("aslklx20002k,777",m.t==0?5:0),localStorage.setItem("n",m.n),localStorage.setItem("i",m.i),m.t==0&&(location.href="/admin"),location.reload()}).catch(m=>{n(3,o="Incorrect email or password")}):n(3,o="Incorrect email or password")}function d(){r=this.value,n(0,r)}function D(){s=this.value,n(1,s)}const _=()=>{document.getElementById("password").type=c?"password":"text",n(4,c=!c)};function M(){a=this.checked,n(2,a)}const K=()=>{console.log(r),r&&r.includes("@echo")&&Et("u/fop",{email:r})},x=()=>{location.href="/contact-us"};return e.$$set=m=>{"func"in m&&n(6,i=m.func)},[r,s,a,o,c,l,i,d,D,_,M,K,x]}class $a extends Cn{constructor(t){super(),kn(this,t,ka,Ca,Tn,{func:6})}}export{$a as L};
