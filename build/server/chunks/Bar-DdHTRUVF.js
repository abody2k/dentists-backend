...
const Bar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<header class="svelte-ivf8z0"><nav class="svelte-ivf8z0"><p>${escape(title)}</p> <button class="svelte-ivf8z0" data-svelte-h="svelte-1nna8zf">رجوع ›</button> <div class="circle1 svelte-ivf8z0" data-svelte-h="svelte-x5dj9v"><img src="/EDTULOGO.png" class="circle3LOGO svelte-ivf8z0"></div></nav></header>`;
});

export { Bar as B };
//# sourceMappingURL=Bar-DdHTRUVF.js.map
