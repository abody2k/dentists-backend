...
import { G as Grid } from './Grid-N_a4wR74.js';
import { B as ButtonChild } from './ButtonChild-B1xyEUzm.js';
import 'jsqr';
import { B as Bar } from './Bar-DP2pBW3D.js';
import './Grid.svelte_svelte_type_style_lang-jTVcioav.js';
import './Button-DLWsFxlA.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${``} ${validate_component(Bar, "Bar").$$render($$result, { title: "Fellowships" }, {}, {})} <div class=""><div style="display: flex;gap:30px">${`${validate_component(ButtonChild, "ButtonChild").$$render(
    $$result,
    {
      child: `
    ...
    {},
    {}
  )}`} <div id="arch" class="svelte-su9afd"><div style="display: flex;gap: 30px;justify-content: right;margin: 30px;"><img> <div>${escape("عرض الزمالات المؤرشفة")}</div></div></div></div> ${validate_component(Grid, "Grid").$$render(
    $$result,
    {
      f: true,
      disablePages: true,
...
//# sourceMappingURL=_page.svelte-D9xRN8dD.js.map
