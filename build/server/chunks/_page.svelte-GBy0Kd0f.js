...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${``} ${validate_component(Bar, "Bar").$$render($$result, { title: "courses" }, {}, {})} <div class="scroll-box svelte-1clgb09"><div style="display: flex;gap:30px;justify-content:right;">${validate_component(ButtonChild, "ButtonChild").$$render(
    $$result,
    {
      child: `
...
//# sourceMappingURL=_page.svelte-GBy0Kd0f.js.map
