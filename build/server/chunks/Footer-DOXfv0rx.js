import { c as create_ssr_component, o as onDestroy, d as add_attribute, v as validate_component } from './ssr-CggYz5VK.js';
...
const Map = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main class="svelte-xi60ah"><div class="svelte-xi60ah"${add_attribute("this", mapElement, 0)}></div> </main>`;
});
const css = {
...
export { Footer as F, Map as M };
//# sourceMappingURL=Footer-DOXfv0rx.js.map
