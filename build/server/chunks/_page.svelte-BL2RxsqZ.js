...
import { C as Course } from './Course-MMs37QHe.js';
import { B as ButtonChild } from './ButtonChild-DSY2k23W.js';
import './Editor-CwxytZuT.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Course, "Course").$$render(
    ...
    {},
    {}
  )} ${`<div style="display: flex;justify-content:space-around" class="svelte-5m3d92"> ${validate_component(ButtonChild, "ButtonChild").$$render(
    $$result,
    {
...
//# sourceMappingURL=_page.svelte-BL2RxsqZ.js.map
