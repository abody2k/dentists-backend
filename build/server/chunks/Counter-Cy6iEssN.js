import { c as create_ssr_component, o as onDestroy, e as escape } from './ssr-CggYz5VK.js';
...
const Counter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.end === void 0 && $$bindings.end && end !== void 0)
    $$bindings.end(end);
  $$result.css.add(css);
  return `<div style="display: flex; flex-direction: row; gap: 20px; /* justify-content: space-evenly; */ align-items: end; width: fit-content; margin: auto;"><div class="main-example svelte-6br8wo"><div class="countdown-container svelte-6br8wo" data-timer="2030/09/05" id="main-example4"><div class="time days svelte-6br8wo"><span class="count curr top svelte-6br8wo">${escape(days)}</span> <span class="count next top svelte-6br8wo">${escape(days)}</span> <span class="count next bottom svelte-6br8wo">${escape(days)}</span> <span class="count curr bottom svelte-6br8wo">${escape(days)}</span> <span class="label svelte-6br8wo">${escape(d5)}</span></div></div></div> <div class="main-example svelte-6br8wo"><div class="countdown-container svelte-6br8wo" data-timer="2030/09/05" id="main-example3"><div class="time hours svelte-6br8wo"><span class="count curr top svelte-6br8wo">${escape(hours)}</span> <span class="count next top svelte-6br8wo">${escape(hoursNext)}</span> <span class="count next bottom svelte-6br8wo">${escape(hoursNext)}</span> <span class="count curr bottom svelte-6br8wo">${escape(hours)}</span> <span class="label svelte-6br8wo">${escape(d5)}</span></div></div></div> <div class="main-example svelte-6br8wo"><div class="countdown-container svelte-6br8wo" data-timer="2030/09/05" id="main-example2"><div class="time minutes svelte-6br8wo"><span class="count curr top svelte-6br8wo">${escape(minutes)}</span> <span class="count next top svelte-6br8wo">${escape(minutesNext)}</span> <span class="count next bottom svelte-6br8wo">${escape(minutesNext)}</span> <span class="count curr bottom svelte-6br8wo">${escape(minutes)}</span> <span class="label svelte-6br8wo">${escape(d5)}</span></div></div></div> <div class="main-example svelte-6br8wo"><div class="countdown-container svelte-6br8wo" data-timer="2030/09/05" id="main-example"><div class="time seconds svelte-6br8wo"><span class="count curr top svelte-6br8wo">${escape(seconds)}</span> <span class="count next top svelte-6br8wo">${escape(secondsNext)}</span> <span class="count next bottom svelte-6br8wo">${escape(secondsNext)}</span> <span class="count curr bottom svelte-6br8wo">${escape(seconds)}</span> <span class="label svelte-6br8wo">${escape(d5)}</span></div></div></div></div>`;
});

export { Counter as C };
//# sourceMappingURL=Counter-Cy6iEssN.js.map
