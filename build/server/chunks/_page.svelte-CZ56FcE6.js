...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let mode = 0;
  $$result.css.add(css);
  return `<div class="row svelte-sj6ybm"><button class="svelte-sj6ybm" data-svelte-h="svelte-1rv1mn6">العروض</button> <button class="svelte-sj6ybm" data-svelte-h="svelte-1jzlhsa">الاقسام</button></div> ${mode == 0 ? `${validate_component(Button, "Button").$$render(
    $$result,
    {
      text: "إضافة فئة",
      clickHandler: () => {
...
//# sourceMappingURL=_page.svelte-CZ56FcE6.js.map
