...
import { C as Card } from './Grid.svelte_svelte_type_style_lang-B___8RzP.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${``} ${validate_component(TopBarMain, "TopBarMain").$$render($$result, { enableTransparency: true }, {}, {})}  <div class="header-image svelte-1eg9cy6"><div class="image-overlay svelte-1eg9cy6"><div class="image-text svelte-1eg9cy6"><p style="position:relative;right:70px; " data-svelte-h="svelte-1mkz37p">About us</p> <p style="font-weight: 300;text-align:left;font-size: 20px; ">${escape(aboutUS)}</p></div></div></div> <div class="scroll-box svelte-1eg9cy6">${`<div class="title" data-svelte-h="svelte-9rjion">Fellowships</div> ${validate_component(Row, "Row").$$render(
    $$result,
    {
      f: true,
      onClick() {
...
//# sourceMappingURL=_page.svelte-DjE6iPHt.js.map
