...
import { B as Bar } from './Bar-DdHTRUVF.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${validate_component(Bar, "Bar").$$render($$result, { title: "إدارة الحسابات" }, {}, {})} <div class="row svelte-1t1a490" style="position: absolute; right: 10px;"><div class="search-container svelte-1t1a490"><span class="search-icon svelte-1t1a490"></span> <input type="search" placeholder="Search..." class="svelte-1t1a490"${add_attribute("value", searchTxt, 0)}></div> ${`<button style="width: fit-content;" class="svelte-1t1a490" data-svelte-h="svelte-ca3r33"><img src="/AddUser.png" width="20px" height="20px" class="svelte-1t1a490"> <div class="svelte-1t1a490">إضافة مستخدم</div></button>`}</div> ${``} <div class="titles svelte-1t1a490" data-svelte-h="svelte-1rndy44"><h3 style="margin:5px 10px;" class="svelte-1t1a490">حسابات المشتركين</h3> <hr class="horizontal-line svelte-1t1a490"></div> <div class="m-container svelte-1t1a490"><table class="svelte-1t1a490" data-svelte-h="svelte-1ag0oxa"><thead class="svelte-1t1a490"><tr class="svelte-1t1a490"><th style="width: 40px;" class="svelte-1t1a490"></th> <th class="svelte-1t1a490"></th> <th class="svelte-1t1a490">ID</th> <th class="svelte-1t1a490">رقم الهاتف والبريد الالكتروني</th> <th class="svelte-1t1a490">اسم المشترك</th> <th class="svelte-1t1a490"></th></tr></thead></table> <div class="table-container svelte-1t1a490"><table class="svelte-1t1a490">${each(users, (user, i) => {
    return `<tr class="svelte-1t1a490"><td class="svelte-1t1a490" data-svelte-h="svelte-aczi77"><img src="/Edituser.png" width="30px" class="svelte-1t1a490"></td> <td style="width:20px;text-align:center;" class="svelte-1t1a490">${escape(i)}</td> <td class="svelte-1t1a490">${escape(user.ID)}</td> <td class="svelte-1t1a490">${escape(user.email)} <br class="svelte-1t1a490"> ${escape(user.phonenumber)}</td> <td class="svelte-1t1a490">${escape(user.username)}</td> <td class="svelte-1t1a490">${escape(user.code)}</td> </tr>`;
  })} </table></div></div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-2wv00Yyd.js.map
