...
import { B as BlogCard } from './BlogCard-DkY4Dnb9.js';
import { P as Path } from './Path-DktuJWJw.js';
import { s as showNotification, a as showConfirmation } from './not-CLrN6WpW.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="postesCont svelte-13vb4iy">${validate_component(Bar, "Bar").$$render($$result, { title: "Blogs" }, {}, {})} <div style="width: 100%; display: inline-table;margin:auto; margin-top: 141px;" class="svelte-13vb4iy">${validate_component(Path, "Path").$$render(
    $$result,
    {
...
//# sourceMappingURL=_page.svelte-DPHscl9d.js.map
